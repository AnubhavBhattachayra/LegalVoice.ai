...
const DocumentContext: React.FC<DocumentContextProps> = ({
  ...
  const fetchUserDocuments = async () => {
    ...
    try {
      ...
      setAllDocuments([
        { id: '1', title: 'Rent Agreement', type: 'doc', createdAt: '2023-03-10T08:30:00.000Z' },
        { id: '2', title: 'Power of Attorney', type: 'pdf', createdAt: '2023-04-25T10:15:00.000Z' },
        { id: '3', title: 'Affidavit for Name Change', type: 'pdf', createdAt: '2023-06-10T15:45:00.000Z' },
        { id: '4', title: 'Income Declaration', type: 'doc', createdAt: '2023-07-05T12:30:00.000Z' },
        { id: '5', title: 'Will and Testament', type: 'pdf', createdAt: '2023-05-15T09:20:00.000Z' }
      ]);
    } catch (error) {
  ...
  return (
    <div className="w-full bg-white rounded-lg shadow-md overflow-hidden">
      <div className="p-4 border-b border-gray-200">
        ...
        <p className="text-sm text-gray-600">Add documents for better AI responses</p>
      </div>
        ...
        {selectedDocuments.length > 0 ? (
          <div className="space-y-2">
            {selectedDocuments.map(doc => (
              <div key={doc.id} className="flex items-center justify-between p-2 bg-indigo-50 rounded-md border border-indigo-100">
